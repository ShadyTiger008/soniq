    ...
    <>
      ...
      >
        ...
        <div className="text-left">
          <div className="text-[11px] font-black text-white tracking-tight group-hover:text-primary transition-colors uppercase italic font-space-grotesk">Ask Soniq Buddy</div>
              ...
              <>
                ...
                <div className="p-6 bg-white/[0.02] border-t border-white/5 flex items-center justify-between">
                  ...
                  <div className="flex items-center gap-1 opacity-20">
                    ...
                    <span className="text-[9px] font-black uppercase">Powered by Soniq AI</span>
                  </div>
                </div>
              </>
            )}
