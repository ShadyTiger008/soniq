      ...
      <nav className="fixed top-0 left-0 right-0 z-[100] py-8">
        <div className="mx-auto flex max-w-7xl items-center justify-between px-8 lg:px-16">
          <div className="flex items-center gap-4 group cursor-pointer">
            ...
            <span className="text-3xl font-black tracking-tighter uppercase italic font-space-grotesk">SONIQ</span>
          </div>
          ...
          <div className="flex flex-col md:flex-row justify-between gap-24 mb-32">
             <div className="max-w-xs text-left">
                <div className="flex items-center gap-4 mb-10">
                   ...
                   <span className="font-black tracking-tighter text-3xl uppercase italic font-space-grotesk">SONIQ</span>
                </div>
